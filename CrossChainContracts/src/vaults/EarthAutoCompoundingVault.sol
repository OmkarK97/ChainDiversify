...
import "../strategies/irs/interfaces/ICrossChain.sol";
    ...
    Initializable
{
    ...
    function init(ICrossChain _strategy) public initializer {
        strategy = _strategy;
    }
    ...
    function upgradeStrat() public {
        ...
        ICrossChain prevStrategy = strategy;
        strategy = ICrossChain(stratCandidate.implementation);
